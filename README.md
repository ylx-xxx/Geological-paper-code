...
We also evaluate our model on the external SEN12-RGB dataset under few-shot and zero-shot settings. Below are example predictions.  
（我们还在外部 SEN12-RGB 数据集上评估了模型在少样本和零样本设置下的表现。以下是部分预测结果。）
